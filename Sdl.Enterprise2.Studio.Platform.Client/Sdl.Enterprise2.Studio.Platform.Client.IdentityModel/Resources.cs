	...
	internal class Resources
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				if (resourceMan == null)
				{
					ResourceManager resourceManager = resourceMan = new ResourceManager("Sdl.Enterprise2.Studio.Platform.Client.IdentityModel.Resources", typeof(Resources).Assembly);
				}
				return resourceMan;
			}
		}
