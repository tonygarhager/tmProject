...
using Sdl.Enterprise2.MultiTerm.Client.Extensions;
	...
	internal class IdentityInfo : FaultExceptionHandlerBase, IEquatable<IdentityInfo>
	{
		...
		private void IssueToken()
		{
			...
			else
			{
				...
				{
					throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, Sdl.Enterprise2.MultiTerm.Client.Discovery.Resources.UnsupportedUriScheme, TokenManagerAddress.Uri.Scheme));
				}
				switch (Credentials.UserType)
				{
				case UserManagerTokenType.WindowsUser:
