	...
	public class CloudBasedTranslationMemory : RemoteTranslationMemory, ITranslationMemory2015, ITranslationMemory, ITranslationProvider
	{
		...
		public CloudBasedTranslationMemoryLanguageDirectionCollection LanguageDirections
		{
			get
			{
				...
				{
					LanguageDirectionEntity[] languageDirectionsByTranslationMemoryId = null;// Provider.Service.GetLanguageDirectionsByTranslationMemoryId(base.Entity.Id, new string[0]);
		...
		public void Save()
		{
			if (base.IsNewObject)
			{
				TranslationMemoryEntity translationMemoryEntity = null;// Provider.Service.CreateTranslationMemory(base.Entity, "/");
			...
			{
				TranslationMemoryEntity translationMemoryEntity = null;// Provider.Service.UpdateTranslationMemory(base.Entity);
            }
		}
