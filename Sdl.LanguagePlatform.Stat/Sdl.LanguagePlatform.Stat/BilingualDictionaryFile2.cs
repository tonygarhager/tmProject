...
{
	public class BilingualDictionaryFile2 : IBilingualPhraseCounter2
	{
		...
		public PhraseDictionary2 SourcePhrases
		{
			get;
			internal set;
		}

		public PhraseDictionary2 TargetPhrases
		{
			get;
			internal set;
		}
		...
		public BilingualDictionaryFile2(DataLocation2 location, CultureInfo srcCulture, CultureInfo trgCulture)
		{
			_info = location.FindComponent(DataFileType.PhraseMappingFile, srcCulture, trgCulture);
			SourcePhrases = new PhraseDictionary2(_info.Location, _info.SourceCulture);
			TargetPhrases = new PhraseDictionary2(_info.Location, _info.TargetCulture);
		...
		private static void MarkUnusedPhrases(PhraseDictionary2 phrases, IList<int> phraseCounts)
		{
			int num = 0;
		...
		{
			DataFileInfo2 dataFileInfo = new DataFileInfo2(_info.Location, _info.DataType, _info.TargetCulture, _info.SourceCulture);
