...
{
	internal class DiskBasedMergeCounter<T> where T : IComparable<T>, ICountable
	{
		...
		public DiskBasedMergeCounter(IBinaryReaderWriter<T> readerWriter, string tempFilePrefix, string tempFileLocation, int maxMemoryItems)
		{
